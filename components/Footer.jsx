...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-[#F3F4F6]" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      <div className="w-full px-[60px] pt-[50px] pb-8">
        <div className="grid grid-cols-4 gap-8">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link href="/dashboard/sales">
              <button style={{
                backgroundColor: '#284297', color: 'white',
          ...
          <div className="flex flex-col gap-4 pt-1">
            <Link href="/"
              style={{ fontSize: '14px', fontWeight: 500, color: '#FF8A65', textDecoration: 'none' }}>
              All listing
            </Link>
            <Link href="/about"
              style={{ fontSize: '14px', fontWeight: 400, color: '#374151', textDecoration: 'none' }}
              className="hover:text-gray-900 transition-colors">
              About us
            </Link>
            <Link href="/faqs"
          ...
          <div className="flex flex-col gap-4 pt-1">
            ...
            <div className="flex items-center bg-white rounded-full border border-gray-200 overflow-hidden"
              ...
              />
              <button style={{
                backgroundColor: '#FF8A65', color: 'white',
            ...
            <div className="flex flex-col gap-3 mt-2">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="w-fit">
                <div className="w-10 h-10 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
                  style={{ backgroundColor: '#284297' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="white">
                    <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/>
                  </svg>
      ...
      <div className="border-t border-gray-200 py-4 w-full px-[60px] flex justify-end"
        style={{ backgroundColor: '#F3F4F6' }}>
        <p style={{ fontSize: '13px', color: '#6B7280', fontWeight: 400 }}>
          © All Right Reserved by | ShopRise | Copyright 2023
        </p>
