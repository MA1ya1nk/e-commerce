...
function ListingDropdown({ onEdit, onDelete }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 bottom-full mb-1 bg-white border border-gray-200 rounded-[8px] shadow-lg z-50 overflow-hidden"
          style={{ width: '110px' }}>
      ...
      <div className="grid grid-cols-2 overflow-y-auto" style={{ width: '1023px', maxHeight: '632px', gap: '20px' }}>
        {listings.map(item => (
          <div key={item.id} className="flex bg-white border border-gray-200 relative"
            style={{ width: '500px', height: '143px', borderRadius: '10px', padding: '10px', gap: '10px', borderWidth: '1px' }}>
            ...
            <div className="flex flex-col justify-between" style={{ width: '350px', height: '123px', gap: '5px' }}>
              ...
              <p style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '10px', lineHeight: '16px', letterSpacing: '0%', color: '#6B7280' }}>
                {item.description}
              </p>
              ...
              <div className="flex items-center gap-1">
                <span style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '11px', lineHeight: '100%', letterSpacing: '0%', color: '#9CA3AF' }}>
                  Listed on {item.date}
                </span>
