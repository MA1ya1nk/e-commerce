...
const FavouritesPage = () => {
  return (
    <div className="flex bg-[#F9FAFB] min-h-screen" style={{ fontFamily: 'Inter, sans-serif' }}>
      ...
      {/* ── SIDEBAR ── matches exact sizing from other pages: w-[210px] */}
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="px-8 pt-6 pb-10">
          ...
          {/* Product Grid — 5 cols, width 1023px, gap 13px */}
          <div
            style={{
              width: '1023px',
              display: 'grid',
          ...
          >
            {products.map((_, index) => (
              ...
              >
                {/* Image */}
                <div className="w-full h-[100px] bg-gray-100 rounded-[8px] overflow-hidden relative shrink-0">
                ...
                <div className="flex flex-col gap-1">
                  <h3
                    className="truncate"
                    style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: '14px', lineHeight: '100%', color: '#111827' }}
                  >
                    Litter trolley sprayer
                  </h3>

                  <div className="flex justify-between items-center mt-0.5">
                    <span style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: '12px', color: '#1F3A93' }}>
                      $9.99
                    </span>
                    <span className="text-gray-400 text-[10px]">(Used)</span>
                  </div>

                  <span style={{ fontFamily: 'Inter', fontWeight: 400, fontSize: '12px', color: '#6B7280' }} className="mt-0.5">
                    Los Angeles, CA
                  </span>
                </div>
              </div>
