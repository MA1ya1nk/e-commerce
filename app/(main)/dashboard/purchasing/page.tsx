        ...
        <div className="px-8 pt-6 pb-10 flex flex-col gap-5">
          ...
          <div className="flex items-center justify-between gap-4">
            <div className="flex items-center border border-gray-200 rounded-[8px] px-3 h-[38px] gap-2 bg-white" style={{ width: '360px' }}>
              ...
              <input
                className="outline-none text-[13px] w-full text-gray-600 bg-transparent placeholder-gray-300"
                placeholder="Search..."
              />
            </div>
          ...
          {activeTab === 'Following' ? (
            <div
              ...
              style={{ width: '1023px', maxHeight: '708px', gap: '10px', alignContent: 'start' }}
            >
              {followedSellers.map((seller, idx) => (
                <div
                  key={idx}
                  className="border border-gray-200 flex items-center bg-white"
                  style={{ width: '329px', height: '103px', borderRadius: '10px', padding: '10px', gap: '10px' }}
                >
                  ...
                  <div className="flex flex-col flex-1 h-full justify-between py-0.5">
                    <div className="flex justify-between items-start">
                      <span style={{ fontFamily: 'Inter', fontSize: '14px', fontWeight: 500, lineHeight: '18px', color: '#111827' }}
                        className="truncate max-w-[104px]">
                        {seller.name}
                      </span>
                    ...
                    <span style={{ fontFamily: 'Inter', fontSize: '12px', fontWeight: 400, color: '#6B7280' }}>
                      {seller.joined}
                    </span>
            ...
            /* ── Table (Purchasing & Offers) ── */
            <div className="w-full max-w-[1023px] bg-white border border-gray-100 rounded-[12px] overflow-hidden">
                ...
                <tbody className="bg-white">
                  {orders.map((order, i) => (
                    <tr key={i} className="border-b border-gray-50 last:border-0 hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-3 whitespace-nowrap text-gray-700 overflow-hidden text-ellipsis">{order.name}</td>
                      <td className="px-4 py-3">
